...
<body>
    ...
    <section class="sobre bloco scrollSpy" id="sobre">
        <div class="row container">
            ...
            <div class="col 12 l6">
                <p class="light">
                    O Centro Boa Forma chegou a Cuiabá e região trazendo um novo conceito em prevenção, promoção e
                    reabilitação da saúde. Localizado no centro da cidade, conta com fácil estacionamento, salas amplas
                    e climatizadas, ambiente confortável e seguro aos seus usuários. Suas instalações foram projetadas e
                    equipadas sob medida, dentro dos padrões de acessibilidade, para acolher principalmente pessoas com
                    limitações funcionais. O centro dispõe de uma equipe profissional qualificada e com experiêncis no
                    mercado, prezando sempre por tratamentos individualizados e baseados em evidências científicas.
                </p>
            </div>
        ...
        <div class="row blue-logo missao-visao-valores">
            <div class="container">
                <article class="item col s12 m4 center">
                    ...
                    <p class="light">Promover a saúde e bem-estar dos clientes com ações de prevenção, promoção e
                        reabilitação, através de tratamentos eficazes e humanizados em fisioterapia e sua vertentes.</p>
                </article>
                <article class="item col s12 m4 center">
                    ...
                    <p class="light">Tornar-se referência no cenário estadual, buscando a excelência dos serviços
                        prestados, além de promover o desenvolvimento técnico-científico de sua equipe e da sociedade.
                    </p>
                </article>
                <article class="item col s12 m4 center">
    ...
    <section class="servicos bloco scrollSpy" id="servicos">
        <div class="row container">
            <div class="col s12 center">
                ...
                <p class="light paragrafo white-text">Suas instalações foram projetadas e equipadas sob medida, dentro dos padrões de
                    acessibilidade, para acolher principalmente pessoas com limitações funcionais. A clínica dispõe de
                    uma equipe profissional qualificada e com experiência no mercado, prezando sempre por tratamentos
        ...
        <div class="row container">
            ...
            <article class="col s12 m6 l3">
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <p light>Pilates é um método de controle muscular desenvolvido por Joseph Pilates...</p>
                    </div>
                </div>
            </article>
            <!--MODAL PILATES-->
            <div class="modal" id="pilates-modal">
                <div class="modal-content">
                    ...
                    <ul class="collection">
                        <li class="collection-item">Alongas, tonificar e definir a musculatura sem exageros;</li>
                        <li class="collection-item">Melhorar a postura;</li>
                        <li class="collection-item">Tonificar a musculatura profunda do abdômen;</li>
                        <li class="collection-item">Previnir e recuperar lesões;</li>
            ...
            <article class="col s12 m6 l3">
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <p light>Ele planeja, administra e coordena programas de alimentação e nutrição em empresas...</p>
                    </div>
                </div>
            </article>
            <!--MODAL NUTRIÇÃO-->
            <div class="modal" id="nutricao-modal">
                <div class="modal-content">
                    ...
                    <p class="light black-text">Seja por um estilo de vida saudável ou para eliminar peso, a preocupação com os alimentos é constante na rotina das pessoas. Por isso é importante saber commer e dar relevância ao que se come. Uma nutrição adequada pode previnir doenças e tornar a vida mais saudável.</p>
                </div>
                <div class="modal-footer">
                    <a class="btn blue-logo modal-action modal-close">Sair</a>
                </div>
            ...
            <article class="col s12 m6 l3">
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <p light>O fisioterapeuta trata e previne doenças e lesões, empregando técnicas...</p>
                    </div>
                </div>
            </article>
            <!--MODAL FISIOTERAPIA-->
            <div class="modal" id="fisio-modal">
                <div class="modal-content">
                    <h5 class="light">O que faz um fisioterapeuta?</h5>
                    <p class="light black-text">O fisioterapia atua no tratamento e prevenção de doenças e lesões, decorrentes de fraturas ou má-formação ou vícios de postura. Tem como aliados, técnicas como massagens e exercícios que restaurem a capacidade física e funcionam do pacientes.</p>
                </div>
                <div class="modal-footer">
                    <a class="btn blue-logo modal-action modal-close">Sair</a>
                </div>
            ...
            <article class="col s12 m6 l3">
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <p light>O treinamento funcional é um método de trabalho ainda mais dinâmico...</p>
                    </div>
                </div>
            </article>
            <!--MODAL FISIOTERAPIA-->
            <div class="modal" id="funcional-modal">
                <div class="modal-content">
                    <h5 class="light">Para que serve o funcional?</h5>
                    <p class="light black-text">O treinamento funcional se baseia nos movimentos naturais do ser humano, como pular, correr, puxar, agachar, girar e empurrar. O praticante ganha força, equilíbrio, flexibilidade, condicionamento, resistência e agilidade.</p>
                </div>
                <div class="modal-footer">
                    <a class="btn blue-logo modal-action modal-close">Sair</a>
                </div>
        ...
        <div class="row container">
                ...
                <div class="card horizontal">
                    ...
                    <div class="card-stacked">
                        <div class="card-content">
                            ...
                            <p class="light">
                                <i class="material-icons left">phone</i>(34) 3684-0000 <br>
            ...
            <article class="col s12 l6">
                <div class="card horizontal">
                    ...
                    <div class="card-stacked">
                        <div class="card-content">
                            <h3 class="card-title light">Cuiabá</h3>
                            <p class="light">
                                <i class="material-icons left">phone</i>(65) 3684-0000 <br>
                                <i class="material-icons left">email</i>cba@boaforma.com <br>
                                <i class="material-icons left">location_on</i>Av. do CPA, 123
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card horizontal">
                    ...
                    <div class="card-stacked">
                        <div class="card-content">
                            ...
                            <p class="light">
                                <i class="material-icons left">phone</i>(11) 3684-0000 <br>
                                <i class="material-icons left">email</i>sp@boaforma.com <br>
                                <i class="material-icons left">location_on</i>Av. Paulista, 123
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card horizontal">
                    ...
                    <div class="card-stacked">
                        <div class="card-content">
                            ...
                            <p class="light">
                                <i class="material-icons left">phone</i>(21) 3684-0000 <br>
                                <i class="material-icons left">email</i>rj@boaforma.com <br>
                                <i class="material-icons left">location_on</i>Av. Copacabana, 123
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="row container">
            ...
            <div class="col s12 m6 l4 hide-on-med-only">
                <div class="mapa transparent">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3843.490977460587!2d-56.02716698562908!3d-15.565395089193867!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x939db081d4569a0f%3A0x6e46c2f8b25e05b0!2sR.%20Colider%2C%201%20-%20Dr.%20F%C3%A1bio%20Leite%2C%20Cuiab%C3%A1%20-%20MT%2C%2078052-080!5e0!3m2!1spt-BR!2sbr!4v1613238201605!5m2!1spt-BR!2sbr" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                </div>
            </div>
            <div class="col s12 m6 l4">
                <div class="informacoes white-text">
                    <h4>Redes Sociais</h4>
                    <p class="light">Fique por dentro das novidades, receba dicas ou sismplesmente mostre ao mundo que você faz parte desse projeto sensacional!</p>
                    ...
                    <h4>Endereço</h4>
                    <p class="light">
                        Av. Tenente Coronel Duarte, 123 <br>
                        Centro, Cuiabá - MT
                    </p>
                    <h4>Contatos</h4>
                    <p class="light">
